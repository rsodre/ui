...
export const Collection = {
    render: function Render(args) {
        ...
        return (_jsx("div", { className: "flex gap-2", children: _jsx(CollectibleCard, { ...args, icon: "https://static.cartridge.gg/presets/loot-survivor/icon.png", totalCount: 1, selected: selected, onSelect: () => setSelected(!selected), onClick: selected
...
export const Beasts = {
    render: function Render(args) {
        const [selected, setSelected] = useState(false);
        return (_jsx("div", { className: "flex gap-2", children: _jsx(CollectibleCard, { ...args, icon: "https://static.cartridge.gg/presets/loot-survivor/icon.png", images: [
                ...
                ], totalCount: 1, selected: selected, onClick: selected
                    ? () => setSelected(!selected)
                    : () => toast.success("Clicked") }) }));
    },
};
export const Beast = {
    render: function Render(args) {
        const [selected, setSelected] = useState(false);
        return (_jsx("div", { className: "flex gap-2", children: _jsx(CollectibleCard, { ...args, icon: undefined, images: [
                ...
                ], title: '"Grim Sun" Hippogriff', totalCount: 0, listingCount: 1, selectable: true, selected: selected, onSelect: () => setSelected(!selected), onClick: selected
                    ? () => setSelected(!selected)
                    : () => toast.success("Clicked") }) }));
    },
};
export const GoldenToken = {
    render: function Render(args) {
        ...
        return (_jsx("div", { className: "flex gap-2", children: _jsx(CollectibleCard, { ...args, icon: undefined, images: [
                ...
                ], title: "Golden Token", totalCount: 0, listingCount: 0, selectable: true, selected: selected, onSelect: () => setSelected(!selected), onClick: selected ? () => setSelected(!selected) : undefined }) }));
    },
};
export const Karat = {
    render: function Render(args) {
        const [selected, setSelected] = useState(false);
        return (_jsx("div", { className: "flex gap-2", children: _jsx(CollectibleCard, { ...args, icon: null, images: [
                ...
                ], title: "Karat", totalCount: 1, selectable: true, selected: selected, onSelect: () => setSelected(!selected), onClick: selected ? () => setSelected(!selected) : undefined }) }));
    },
};
export const Bloberts = {
    render: function Render(args) {
        const [selected, setSelected] = useState(false);
        return (_jsx("div", { className: "flex gap-2", children: _jsx(CollectibleCard, { ...args, icon: "https://static.cartridge.gg/presets/blob-arena-amma/icon.png", images: [
                ...
                ], title: "Bloberts", totalCount: 5, selectable: true, selected: selected, onSelect: () => setSelected(!selected), onClick: selected ? () => setSelected(!selected) : undefined, backgroundColor: "#C67927" }) }));
    },
};
export const Duelists = {
    render: function Render(args) {
        const [selected, setSelected] = useState(false);
        return (_jsx("div", { className: "flex gap-2", children: _jsx(CollectibleCard, { ...args, icon: "https://static.cartridge.gg/presets/pistols/icon.png", images: [
                ...
                ], title: "Pistols at Dawn Duelists", totalCount: 1, selectable: true, selected: selected, onSelect: () => setSelected(!selected), onClick: selected ? () => setSelected(!selected) : undefined, backgroundColor: "#57493e" }) }));
    },
};
export const Realms = {
    render: function Render(args) {
        const [selected, setSelected] = useState(false);
        return (_jsx("div", { className: "flex gap-2", children: _jsx(CollectibleCard, { ...args, icon: "https://static.cartridge.gg/presets/eternum/icon.svg", images: [
                ...
                ], title: "Realms", totalCount: 112, selectable: true, selected: selected, onSelect: () => setSelected(!selected), onClick: selected ? () => setSelected(!selected) : undefined, backgroundColor: "#ffffff" }) }));
    },
};
export const Clickable = {
    render: function Render(args) {
        return (_jsx("div", { className: "flex gap-2", children: _jsx(CollectibleCard, { ...args, totalCount: 2, selectable: false, selected: false, onSelect: undefined, onClick: () => toast.success("Clicked") }) }));
    },
};
...
export const Selectable = {
    render: function Render(args) {
        const [selected, setSelected] = useState(false);
        return (_jsx("div", { className: "flex gap-2", children: _jsx(CollectibleCard, { ...args, totalCount: 2, selectable: true, selected: selected, onSelect: () => setSelected(!selected), onClick: selected ? () => setSelected(!selected) : undefined }) }));
    },
};
