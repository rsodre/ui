...
export const Beast = {
    render: function Render(args) {
        ...
        return (_jsx("div", { className: "flex gap-2", children: _jsx(InventoryItemCard, { ...args, selectable: true, selected: selected, onSelect: () => setSelected(!selected), onClick: selected
...
export const GoldenToken = {
    render: function Render(args) {
        const [selected, setSelected] = useState(false);
        return (_jsx("div", { className: "flex gap-2", children: _jsx(InventoryItemCard, { ...args, images: [
                ...
                ], title: "Golden Token #77", selectable: true, selected: selected, onSelect: () => setSelected(!selected), onClick: selected ? () => setSelected(!selected) : undefined }) }));
    },
};
export const Karat = {
    render: function Render(args) {
        ...
        return (_jsx("div", { className: "flex gap-2", children: _jsx(InventoryItemCard, { ...args, images: [
                ...
                ], title: "Karat #123", selectable: true, selected: selected, onSelect: () => setSelected(!selected), onClick: selected ? () => setSelected(!selected) : undefined }) }));
    },
};
export const Blobert = {
    render: function Render(args) {
        ...
        return (_jsx("div", { className: "flex gap-2", children: _jsx(InventoryItemCard, { ...args, images: [
                ...
                ], title: "Blobert #123", selectable: true, selected: selected, onSelect: () => setSelected(!selected), onClick: selected ? () => setSelected(!selected) : undefined, backgroundColor: "#C67927" }) }));
    },
};
export const Duelist = {
    render: function Render(args) {
        ...
        return (_jsx("div", { className: "flex gap-2", children: _jsx(InventoryItemCard, { ...args, images: [
                ...
                ], title: "Pistols at Dawn Duelist #1399", selectable: true, selected: selected, onSelect: () => setSelected(!selected), onClick: selected ? () => setSelected(!selected) : undefined, backgroundColor: "#57493e" }) }));
    },
};
export const Realm = {
    render: function Render(args) {
        ...
        return (_jsx("div", { className: "flex gap-2", children: _jsx(InventoryItemCard, { ...args, images: [
                ...
                ], title: "Shmasmessel", selectable: true, selected: selected, onSelect: () => setSelected(!selected), onClick: selected ? () => setSelected(!selected) : undefined, backgroundColor: "#ffffff" }) }));
    },
};
export const DopeWarsGearSingle = {
    render: function Render(args) {
        return (_jsx("div", { className: "flex gap-2", children: _jsx(InventoryItemCard, { ...args, images: [
                ...
                ], title: "Rolls Royce from Mob Town", selectable: false, selected: false, onSelect: undefined, onClick: () => toast.success("Clicked"), backgroundColor: "#97ADCC", totalCount: 1 }) }));
    },
};
export const DopeWarsGearMultiple = {
    render: function Render(args) {
        return (_jsx("div", { className: "flex gap-2", children: _jsx(InventoryItemCard, { ...args, images: [
                    "https://raw2.seadn.io/optimism/0x0e55e1913c50e015e0f60386ff56a4bfb00d7110/448cb89b7c9c6673de179a7d5bef21/b8448cb89b7c9c6673de179a7d5bef21.svg",
                ], title: "Rolls Royce from Mob Town", selectable: false, selected: false, onSelect: undefined, onClick: () => toast.success("Clicked"), backgroundColor: "#97ADCC", totalCount: 3 }) }));
    },
};
export const Clickable = {
    render: function Render(args) {
        return (_jsx("div", { className: "flex gap-2", children: _jsx(InventoryItemCard, { ...args, listingCount: 0, selectable: false, selected: false, onSelect: undefined, onClick: () => toast.success("Clicked") }) }));
    },
};
...
export const Selectable = {
    render: function Render(args) {
        const [selected, setSelected] = useState(false);
        return (_jsx("div", { className: "flex gap-2", children: _jsx(InventoryItemCard, { ...args, listingCount: 0, selectable: true, selected: selected, onSelect: () => setSelected(!selected), onClick: selected ? () => setSelected(!selected) : undefined }) }));
    },
};
...
//# sourceMappingURL=inventory-item.stories.js.map