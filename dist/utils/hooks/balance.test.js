...
describe("Balance calculation logic", () => {
    ...
    describe("Error scenarios that would cause NaN in old logic", () => {
        ...
        it("should throw on null amount", () => {
            expect(() => calculateBalance(null, 6)).toThrow();
        });
        it("should throw on undefined amount", () => {
            expect(() => calculateBalance(undefined, 6)).toThrow();
        });
        ...
        it("should throw on null decimals", () => {
            expect(() => calculateBalance("1000000", null)).toThrow("Decimals must be a non-negative integer");
        });
        it("should throw on undefined decimals", () => {
            expect(() => calculateBalance("1000000", undefined)).toThrow("Decimals must be a non-negative integer");
        });
