...
export declare enum ActivityFeeUnit {
    Fri = "FRI",
    Wei = "WEI"
}
...
export declare enum AdminBudgetReason {
    Advance = "ADVANCE",
...
export declare enum AttestationIssuerType {
    Oauth = "OAUTH",
    Provider = "PROVIDER",
...
export declare enum AttestationVisibility {
    Private = "PRIVATE",
    Public = "PUBLIC"
}
/**
...
export declare enum CoinbaseNetwork {
    Arbitrum = "ARBITRUM",
    Base = "BASE",
    Ethereum = "ETHEREUM",
    Optimism = "OPTIMISM",
...
export declare enum CoinbaseOnrampStatus {
    Completed = "COMPLETED",
    Failed = "FAILED",
...
export declare enum CoinbaseTransactionStatus {
    Failed = "FAILED",
...
export declare enum DocumentVersionOrderField {
    CreatedAt = "CREATED_AT"
}
/**
...
export declare enum InvoiceOrderField {
    CreatedAt = "CREATED_AT"
}
/**
...
export declare enum LayerswapDestinationNetwork {
...
export declare enum LayerswapSourceNetwork {
...
export declare enum LayerswapStatus {
    Confirmed = "CONFIRMED",
    Expired = "EXPIRED",
    Failed = "FAILED",
    Pending = "PENDING",
...
export declare enum MerkleClaimOrderField {
    CreatedAt = "CREATED_AT"
}
/**
...
export declare enum MerkleDropNetwork {
    Arbitrum = "ARBITRUM",
    Base = "BASE",
    Ethereum = "ETHEREUM",
    Optimism = "OPTIMISM",
...
export declare enum MerkleDropOrderField {
    CreatedAt = "CREATED_AT"
}
/**
...
export declare enum OAuthConnectionOrderField {
    CreatedAt = "CREATED_AT"
}
...
export declare enum OAuthConnectionProvider {
    Instagram = "INSTAGRAM",
    Tiktok = "TIKTOK",
    Twitter = "TWITTER"
}
...
export declare enum PaymasterBudgetFeeUnit {
    Credit = "CREDIT",
    Strk = "STRK"
}
/** A connection to a list of items. */
...
export declare enum PaymasterOutboxOrderField {
    CreatedAt = "CREATED_AT"
}
/** PaymasterOutboxStatus is enum for the field status */
export declare enum PaymasterOutboxStatus {
    New = "NEW",
    Processing = "PROCESSING"
}
/** PaymasterOutboxTransactionStatus is enum for the field transaction_status */
export declare enum PaymasterOutboxTransactionStatus {
    Reverted = "REVERTED",
    Success = "SUCCESS"
}
/**
...
export declare enum PaymasterTransactionFilter {
    All = "ALL",
    Reverted = "REVERTED",
    Success = "SUCCESS"
}
export declare enum PaymasterTransactionOrder {
...
export declare enum RpcLogNetwork {
    Mainnet = "mainnet",
    Sepolia = "sepolia"
}
/**
...
export declare enum StarterpackAcquisitionType {
    Claimed = "CLAIMED",
    Paid = "PAID"
}
/** A connection to a list of items. */
...
export declare enum TeamIncubatorStage {
    Cartridge = "cartridge",
    Kohai = "kohai",
    Senpai = "senpai",
    Sensei = "sensei"
...
export type MerkleDropByKeyQuery = {
    __typename?: 'Query';
    merkleDropByKey?: {
        __typename?: 'MerkleDrop';
        key: string;
...
export type MerkleClaimsForAddressQuery = {
    __typename?: 'Query';
    merkleClaimsForAddress: Array<{
        __typename?: 'MerkleClaim';
        index: number;
        data: Array<string>;
        merkleProof?: Array<string> | null;
        merkleDrop: {
            __typename?: 'MerkleDrop';
            key: string;
            salt: string;
...
export declare const AccountSearchDocument = "\n    query AccountSearch($query: String!, $limit: Int = 5) {\n  searchAccounts(query: $query, limit: $limit) {\n    username\n    credits {\n      amount\n      decimals\n    }\n    updatedAt\n  }\n}\n    ";
export declare const useAccountSearchQuery: <TData = AccountSearchQuery, TError = unknown>(variables: AccountSearchQueryVariables, options?: UseQueryOptions<AccountSearchQuery, TError, TData>) => import("react-query").UseQueryResult<TData, TError>;
...
export declare const MerkleDropByKeyDocument = "\n    query MerkleDropByKey($key: String!) {\n  merkleDropByKey(key: $key) {\n    key\n    salt\n    network\n    contract\n    entrypoint\n    merkleRoot\n    description\n    matchStarterpackItem\n  }\n}\n    ";
export declare const useMerkleDropByKeyQuery: <TData = MerkleDropByKeyQuery, TError = unknown>(variables: MerkleDropByKeyQueryVariables, options?: UseQueryOptions<MerkleDropByKeyQuery, TError, TData>) => import("react-query").UseQueryResult<TData, TError>;
export declare const MerkleClaimsForAddressDocument = "\n    query MerkleClaimsForAddress($keys: [String!]!, $address: String!) {\n  merkleClaimsForAddress(keys: $keys, address: $address) {\n    index\n    data\n    merkleProof\n    merkleDrop {\n      key\n      salt\n      network\n      contract\n      entrypoint\n      merkleRoot\n      description\n      matchStarterpackItem\n    }\n  }\n}\n    ";
export declare const useMerkleClaimsForAddressQuery: <TData = MerkleClaimsForAddressQuery, TError = unknown>(variables: MerkleClaimsForAddressQueryVariables, options?: UseQueryOptions<MerkleClaimsForAddressQuery, TError, TData>) => import("react-query").UseQueryResult<TData, TError>;
...
export declare const LayerswapSourcesDocument = "\n    query LayerswapSources($token: String!, $isMainnet: Boolean) {\n  layerswapSources(token: $token, isMainnet: $isMainnet) {\n    name\n    displayName\n    logo\n    chainId\n    type\n    tokens {\n      symbol\n      displayAsset\n      decimals\n      priceInUsd\n      status\n    }\n    depositMethods\n  }\n}\n    ";
export declare const useLayerswapSourcesQuery: <TData = LayerswapSourcesQuery, TError = unknown>(variables: LayerswapSourcesQueryVariables, options?: UseQueryOptions<LayerswapSourcesQuery, TError, TData>) => import("react-query").UseQueryResult<TData, TError>;
...
export declare const CreateLayerswapPaymentDocument = "\n    mutation CreateLayerswapPayment($input: CreateLayerswapPaymentInput!) {\n  createLayerswapPayment(input: $input) {\n    ...LayerswapPaymentFields\n  }\n}\n    \n    fragment LayerswapPaymentFields on LayerswapPayment {\n  cryptoPaymentId\n  swapId\n  status\n  sourceNetwork\n  sourceTokenAmount\n  sourceTokenAddress\n  sourceDepositAddress\n  expiresAt\n}\n    ";
export declare const useCreateLayerswapPaymentMutation: <TError = unknown, TContext = unknown>(options?: UseMutationOptions<CreateLayerswapPaymentMutation, TError, CreateLayerswapPaymentMutationVariables, TContext>) => import("react-query").UseMutationResult<CreateLayerswapPaymentMutation, TError, Exact<{
    input: CreateLayerswapPaymentInput;
}>, TContext>;
export declare const CreateLayerswapDepositDocument = "\n    mutation CreateLayerswapDeposit($input: CreateLayerswapDepositInput!) {\n  createLayerswapDeposit(input: $input) {\n    ...LayerswapPaymentFields\n  }\n}\n    \n    fragment LayerswapPaymentFields on LayerswapPayment {\n  cryptoPaymentId\n  swapId\n  status\n  sourceNetwork\n  sourceTokenAmount\n  sourceTokenAddress\n  sourceDepositAddress\n  expiresAt\n}\n    ";
export declare const useCreateLayerswapDepositMutation: <TError = unknown, TContext = unknown>(options?: UseMutationOptions<CreateLayerswapDepositMutation, TError, CreateLayerswapDepositMutationVariables, TContext>) => import("react-query").UseMutationResult<CreateLayerswapDepositMutation, TError, Exact<{
    input: CreateLayerswapDepositInput;
}>, TContext>;
export declare const LayerswapQuoteDocument = "\n    query LayerswapQuote($input: CreateLayerswapDepositInput!) {\n  layerswapQuote(input: $input) {\n    requestedAmount\n    receivedAmount\n    totalFees\n    averageCompletionTime\n  }\n}\n    ";
export declare const useLayerswapQuoteQuery: <TData = LayerswapQuoteQuery, TError = unknown>(variables: LayerswapQuoteQueryVariables, options?: UseQueryOptions<LayerswapQuoteQuery, TError, TData>) => import("react-query").UseQueryResult<TData, TError>;
export declare const LayerswapStatusDocument = "\n    query LayerswapStatus($swapId: ID!, $isMainnet: Boolean) {\n  layerswapStatus(swapId: $swapId, isMainnet: $isMainnet)\n}\n    ";
export declare const useLayerswapStatusQuery: <TData = LayerswapStatusQuery, TError = unknown>(variables: LayerswapStatusQueryVariables, options?: UseQueryOptions<LayerswapStatusQuery, TError, TData>) => import("react-query").UseQueryResult<TData, TError>;
export declare const CoinbaseOnrampTransactionsDocument = "\n    query CoinbaseOnrampTransactions($input: CoinbaseTransactionsInput!) {\n  coinbaseOnrampTransactions(input: $input) {\n    transactions {\n      transactionId\n      walletAddress\n      type\n      txHash\n      status\n      purchaseCurrency\n      purchaseNetwork\n      purchaseAmount {\n        amount\n        currency\n      }\n      paymentTotal {\n        amount\n        currency\n      }\n      coinbaseFee {\n        amount\n        currency\n      }\n      networkFee {\n        amount\n        currency\n      }\n    }\n    nextPageKey\n    totalCount\n  }\n}\n    ";
export declare const useCoinbaseOnrampTransactionsQuery: <TData = CoinbaseOnrampTransactionsQuery, TError = unknown>(variables: CoinbaseOnrampTransactionsQueryVariables, options?: UseQueryOptions<CoinbaseOnrampTransactionsQuery, TError, TData>) => import("react-query").UseQueryResult<TData, TError>;
export declare const CreateCoinbaseOnRampOrderDocument = "\n    mutation CreateCoinbaseOnRampOrder($input: CreateCoinbaseOnrampOrderInput!) {\n  createCoinbaseOnrampOrder(input: $input) {\n    ...CoinbaseOnrampOrderResponseFields\n  }\n}\n    \n    fragment CoinbaseOnrampOrderResponseFields on CoinbaseOnrampOrderResponse {\n  coinbaseOrder {\n    ...CoinbaseOnrampOrderFields\n  }\n  layerswapPayment {\n    ...LayerswapPaymentFields\n  }\n}\n    \n    fragment CoinbaseOnrampOrderFields on CoinbaseOnrampOrder {\n  orderId\n  paymentLink\n  paymentLinkType\n  paymentTotal\n  paymentCurrency\n  purchaseAmount\n  purchaseCurrency\n  destinationAddress\n  destinationNetwork\n  fees {\n    type\n    amount\n    currency\n  }\n}\n    \n\n    fragment LayerswapPaymentFields on LayerswapPayment {\n  cryptoPaymentId\n  swapId\n  status\n  sourceNetwork\n  sourceTokenAmount\n  sourceTokenAddress\n  sourceDepositAddress\n  expiresAt\n}\n    ";
export declare const useCreateCoinbaseOnRampOrderMutation: <TError = unknown, TContext = unknown>(options?: UseMutationOptions<CreateCoinbaseOnRampOrderMutation, TError, CreateCoinbaseOnRampOrderMutationVariables, TContext>) => import("react-query").UseMutationResult<CreateCoinbaseOnRampOrderMutation, TError, Exact<{
    input: CreateCoinbaseOnrampOrderInput;
}>, TContext>;
export declare const CreateCoinbaseLayerswapOrderDocument = "\n    mutation CreateCoinbaseLayerswapOrder($input: CreateCoinbaseLayerswapOrderInput!) {\n  createCoinbaseLayerswapOrder(input: $input) {\n    ...CoinbaseOnrampOrderResponseFields\n  }\n}\n    \n    fragment CoinbaseOnrampOrderResponseFields on CoinbaseOnrampOrderResponse {\n  coinbaseOrder {\n    ...CoinbaseOnrampOrderFields\n  }\n  layerswapPayment {\n    ...LayerswapPaymentFields\n  }\n}\n    \n    fragment CoinbaseOnrampOrderFields on CoinbaseOnrampOrder {\n  orderId\n  paymentLink\n  paymentLinkType\n  paymentTotal\n  paymentCurrency\n  purchaseAmount\n  purchaseCurrency\n  destinationAddress\n  destinationNetwork\n  fees {\n    type\n    amount\n    currency\n  }\n}\n    \n\n    fragment LayerswapPaymentFields on LayerswapPayment {\n  cryptoPaymentId\n  swapId\n  status\n  sourceNetwork\n  sourceTokenAmount\n  sourceTokenAddress\n  sourceDepositAddress\n  expiresAt\n}\n    ";
export declare const useCreateCoinbaseLayerswapOrderMutation: <TError = unknown, TContext = unknown>(options?: UseMutationOptions<CreateCoinbaseLayerswapOrderMutation, TError, CreateCoinbaseLayerswapOrderMutationVariables, TContext>) => import("react-query").UseMutationResult<CreateCoinbaseLayerswapOrderMutation, TError, Exact<{
    input: CreateCoinbaseLayerswapOrderInput;
}>, TContext>;
export declare const CoinbaseOnRampOrderDocument = "\n    query CoinbaseOnRampOrder($orderId: String!) {\n  coinbaseOnrampOrder(orderId: $orderId) {\n    txHash\n    status\n  }\n}\n    ";
export declare const useCoinbaseOnRampOrderQuery: <TData = CoinbaseOnRampOrderQuery, TError = unknown>(variables: CoinbaseOnRampOrderQueryVariables, options?: UseQueryOptions<CoinbaseOnRampOrderQuery, TError, TData>) => import("react-query").UseQueryResult<TData, TError>;
export declare const CoinbaseOnRampQuoteDocument = "\n    query CoinbaseOnRampQuote($input: CoinbaseOnrampQuoteInput!) {\n  coinbaseOnrampQuote(input: $input) {\n    quoteId\n    paymentTotal {\n      amount\n      currency\n    }\n    purchaseAmount {\n      amount\n      currency\n    }\n    layerswapFees {\n      amount\n      currency\n    }\n    coinbaseFee {\n      amount\n      currency\n    }\n    networkFee {\n      amount\n      currency\n    }\n  }\n}\n    ";
export declare const useCoinbaseOnRampQuoteQuery: <TData = CoinbaseOnRampQuoteQuery, TError = unknown>(variables: CoinbaseOnRampQuoteQueryVariables, options?: UseQueryOptions<CoinbaseOnRampQuoteQuery, TError, TData>) => import("react-query").UseQueryResult<TData, TError>;
export declare const PlaythroughsDocument = "\n    query Playthroughs($projects: [PlaythroughProject!]!) {\n  playthroughs(projects: $projects) {\n    items {\n      playthroughs {\n        entrypoints\n        sessionStart\n        sessionEnd\n        actionCount\n        callerAddress\n      }\n      meta {\n        project\n        limit\n        error\n        count\n      }\n    }\n  }\n}\n    ";
export declare const usePlaythroughsQuery: <TData = PlaythroughsQuery, TError = unknown>(variables: PlaythroughsQueryVariables, options?: UseQueryOptions<PlaythroughsQuery, TError, TData>) => import("react-query").UseQueryResult<TData, TError>;
...
export declare const SessionsDocument = "\n    query Sessions($where: SessionWhereInput!) {\n  sessions(where: $where) {\n    edges {\n      node {\n        id\n        appID\n        chainID\n        isRevoked\n        expiresAt\n        createdAt\n        updatedAt\n        metadata {\n          os\n          browser\n        }\n      }\n    }\n  }\n}\n    ";
export declare const useSessionsQuery: <TData = SessionsQuery, TError = unknown>(variables: SessionsQueryVariables, options?: UseQueryOptions<SessionsQuery, TError, TData>) => import("react-query").UseQueryResult<TData, TError>;
...
export declare const ClaimFreeStarterpackDocument = "\n    mutation ClaimFreeStarterpack($input: StarterpackInput!) {\n  claimFreeStarterpack(input: $input)\n}\n    ";
export declare const useClaimFreeStarterpackMutation: <TError = unknown, TContext = unknown>(options?: UseMutationOptions<ClaimFreeStarterpackMutation, TError, ClaimFreeStarterpackMutationVariables, TContext>) => import("react-query").UseMutationResult<ClaimFreeStarterpackMutation, TError, Exact<{
    input: StarterpackInput;
}>, TContext>;
...
export declare const useTeamsQuery: <TData = TeamsQuery, TError = unknown>(variables?: TeamsQueryVariables, options?: UseQueryOptions<TeamsQuery, TError, TData>) => import("react-query").UseQueryResult<TData, TError>;
...
export declare const SendEmailVerificationDocument = "\n    mutation SendEmailVerification($input: SendEmailVerificationInput!) {\n  sendEmailVerification(input: $input) {\n    success\n    message\n  }\n}\n    ";
export declare const useSendEmailVerificationMutation: <TError = unknown, TContext = unknown>(options?: UseMutationOptions<SendEmailVerificationMutation, TError, SendEmailVerificationMutationVariables, TContext>) => import("react-query").UseMutationResult<SendEmailVerificationMutation, TError, Exact<{
    input: SendEmailVerificationInput;
}>, TContext>;
export declare const SendPhoneVerificationDocument = "\n    mutation SendPhoneVerification($input: SendPhoneVerificationInput!) {\n  sendPhoneVerification(input: $input) {\n    success\n    message\n  }\n}\n    ";
export declare const useSendPhoneVerificationMutation: <TError = unknown, TContext = unknown>(options?: UseMutationOptions<SendPhoneVerificationMutation, TError, SendPhoneVerificationMutationVariables, TContext>) => import("react-query").UseMutationResult<SendPhoneVerificationMutation, TError, Exact<{
    input: SendPhoneVerificationInput;
}>, TContext>;
export declare const VerifyEmailDocument = "\n    mutation VerifyEmail($input: VerifyEmailInput!) {\n  verifyEmail(input: $input) {\n    success\n    message\n    verifiedValue\n  }\n}\n    ";
export declare const useVerifyEmailMutation: <TError = unknown, TContext = unknown>(options?: UseMutationOptions<VerifyEmailMutation, TError, VerifyEmailMutationVariables, TContext>) => import("react-query").UseMutationResult<VerifyEmailMutation, TError, Exact<{
    input: VerifyEmailInput;
}>, TContext>;
export declare const VerifyPhoneDocument = "\n    mutation VerifyPhone($input: VerifyPhoneInput!) {\n  verifyPhone(input: $input) {\n    success\n    message\n    verifiedValue\n  }\n}\n    ";
export declare const useVerifyPhoneMutation: <TError = unknown, TContext = unknown>(options?: UseMutationOptions<VerifyPhoneMutation, TError, VerifyPhoneMutationVariables, TContext>) => import("react-query").UseMutationResult<VerifyPhoneMutation, TError, Exact<{
    input: VerifyPhoneInput;
}>, TContext>;
