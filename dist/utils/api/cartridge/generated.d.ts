...
export type CoinbaseOnrampRequirementsQuery = {
    __typename?: 'Query';
    coinbaseOnrampRequirements: {
        __typename?: 'CoinbaseOnrampRequirements';
        needsEmail: boolean;
...
export declare const CoinbaseOnrampRequirementsDocument = "\n    query CoinbaseOnrampRequirements($username: String!) {\n  coinbaseOnrampRequirements(username: $username) {\n    needsEmail\n    needsPhoneNumber\n    needsPhoneVerification\n  }\n}\n    ";
export declare const useCoinbaseOnrampRequirementsQuery: <TData = CoinbaseOnrampRequirementsQuery, TError = unknown>(variables: CoinbaseOnrampRequirementsQueryVariables, options?: UseQueryOptions<CoinbaseOnrampRequirementsQuery, TError, TData>) => import("react-query").UseQueryResult<TData, TError>;
